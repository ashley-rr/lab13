...
public class FamilyTree
{
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0){
			throw new TreeException("Colon index is less than 0"); //throw a TreeException with a useful message
		}
...
//		// Add child nodes to parentNode.
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null) {
			throw new TreeException("Node 1 doesn't exist"); //Throw a TreeException with a useful message
		}
		
		TreeNode node2 = root.getNodeWithName(name2);		// node whose name is name2
		if (node2 == null) {
			throw new TreeException("Node 2 doesn't exist"); //Throw a TreeException with a useful message
		}
